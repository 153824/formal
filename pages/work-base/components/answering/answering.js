...
Page({
  ...
  formSubmit: function (e) {
    ...
    if (app.isTest) {
      wx.redirectTo({
        url: '../done/done?type=' + that.data.applyStatus + "&reportMeet=" +that.data.reportMeet
      });
      console.log('../done/done?type=' + that.data.applyStatus + "&reportMeet=" +that.data.reportMeet);
      return;
    }
    var now = new Date().getTime();
    var data = this.data;
    ...
    app.doAjax({
      ...
      success: function (ret) {
        console.log('../done/done?id=' + data.id + "&type=" + that.data.applyStatus  + "&reportMeet" +that.data.reportMeet);
        wx.redirectTo({
          url: '../done/done?id=' + data.id + "&type=" + that.data.applyStatus  + "&reportMeet=" +that.data.reportMeet
        });
